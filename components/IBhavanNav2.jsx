...
const IBhavanNav2 = ({ currentPage, navigate, openGetInTouch, theme, toggleTheme }) => {
  const [servicesOpen, setServicesOpen] = React.useState(false);
  const [activeService, setActiveService] = React.useState('smart-home');
      ...
      <div className="nav-inner">
        <div className="nav-logo" onClick={() => go('home')}>
          ...
          <div className="logo-stack">
            <div className="name" style={{ fontFamily: "\"Instrument Serif\"", fontSize: "25px" }}>iBhavan</div>
...
Object.assign(window, { IBhavanNav2 });