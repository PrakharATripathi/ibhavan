...
window.IBHAVAN_IMG = {
  // Smart home
  smartHome: 'https://images.unsplash.com/photo-1558002038-1055907df827?auto=format&fit=crop&w=1200&q=80',
  // HR / team office
  hr: 'https://images.unsplash.com/photo-1600880292203-757bb62b4baf?auto=format&fit=crop&w=1200&q=80',
  // IT / servers / code
  it: 'https://images.unsplash.com/photo-1551434678-e076c223a692?auto=format&fit=crop&w=1200&q=80',
  // Founder portrait
  founder: 'https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&w=900&q=80',
  // Mosaic grid
  mosaic1: 'https://images.unsplash.com/photo-1616486338812-3dadae4b4ace?auto=format&fit=crop&w=1400&q=80',
  mosaic2: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?auto=format&fit=crop&w=1000&q=80',
  mosaic3: 'https://images.unsplash.com/photo-1558494949-ef010cbdcc31?auto=format&fit=crop&w=900&q=80',
  mosaic4: 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?auto=format&fit=crop&w=900&q=80',
  mosaic5: 'https://images.unsplash.com/photo-1497366216548-37526070297c?auto=format&fit=crop&w=900&q=80',
  mosaic6: 'https://images.unsplash.com/photo-1581092921461-eab62e97a780?auto=format&fit=crop&w=900&q=80',
  // CTA backdrop
  ctaBackdrop: 'https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?auto=format&fit=crop&w=1800&q=80',
  // About / team / office
  aboutHero: 'https://images.unsplash.com/photo-1497366811353-6870744d04b2?auto=format&fit=crop&w=1600&q=80',
  team1: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?auto=format&fit=crop&w=600&q=80',
  team2: 'https://images.unsplash.com/photo-1580489944761-15a19d654956?auto=format&fit=crop&w=600&q=80',
  team3: 'https://images.unsplash.com/photo-1519085360753-af0119f7cbe7?auto=format&fit=crop&w=600&q=80',
  team4: 'https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?auto=format&fit=crop&w=600&q=80',
  // Service hero images
  smartHomeHero: 'https://images.unsplash.com/photo-1586023492125-27b2c045efd7?auto=format&fit=crop&w=1800&q=80',
  hrHero: 'https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&w=1800&q=80',
  itHero: 'https://images.unsplash.com/photo-1504384308090-c894fdcc538d?auto=format&fit=crop&w=1800&q=80',
  // Products
  productDefault: 'https://images.unsplash.com/photo-1558002038-1055907df827?auto=format&fit=crop&w=800&q=80',
  // Blogs
  blogHero: 'https://images.unsplash.com/photo-1518770660439-4636190af475?auto=format&fit=crop&w=1600&q=80',
  blog1: 'https://images.unsplash.com/photo-1558002038-1055907df827?auto=format&fit=crop&w=800&q=80',
  blog2: 'https://images.unsplash.com/photo-1600880292203-757bb62b4baf?auto=format&fit=crop&w=800&q=80',
  blog3: 'https://images.unsplash.com/photo-1504384308090-c894fdcc538d?auto=format&fit=crop&w=800&q=80',
};

window.IBHAVAN_SERVICES = {
  'smart-home': {
    label: 'Smart Home',
...
window.IBHAVAN_PRODUCTS = [
  { id: 'p-hub', name: 'iBhavan Smart Hub', cat: 'Smart Home', desc: 'Central controller for lights, climate, security & voice — works with Matter, Zigbee & Wi-Fi.', img: 'https://images.unsplash.com/photo-1558002038-1055907df827?q=80&w=900&auto=format&fit=crop' },
...
window.IBHAVAN_JOBS = [
  ...
  { id: 6, title: 'Business Development Manager', dept: 'Sales', type: 'Full-time', loc: 'Pune', exp: '4–6 yrs', skills: ['B2B Sales','Tech Solutions','CRM'], hot: true,
    about: 'Drive new business across our Smart Home, HR, and IT verticals.',
...
window.IBHAVAN_BLOGS = [
  { id: 1, title: 'How Smart Lighting Can Cut Your Energy Bills by 40%', cat: 'Smart Home', read: '5 min', date: 'April 15, 2026', author: 'Priya Mehta', tag: 'Featured',
  ...
  { id: 6, title: 'Voice Control Is the New Remote: Rethinking Home UX', cat: 'Smart Home', read: '4 min', date: 'March 18, 2026', author: 'Priya Mehta',
...
// Curated lifestyle imagery (Unsplash, fixed URLs with specific photo IDs)
window.IBHAVAN_IMG = {
