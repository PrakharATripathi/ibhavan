...
// Standardized site-wide CTA — derived from Home page master design
const HomeCTA = ({ openGetInTouch, navigate, secondaryAction }) => {
...
Object.assign(window, { Reveal, Counter, Section, SectionHead, Modal, GetInTouchModal, HomeCTA });